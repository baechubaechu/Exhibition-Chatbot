  ...
  return (
    <div style={{ maxWidth: 1000, margin: "0 auto", padding: 24 }}>
      ...
      <table style={{ width: "100%", borderCollapse: "collapse", marginTop: 20, fontSize: "0.85rem" }}>
        <thead>
          <tr>
            <th style={{ borderBottom: "1px solid var(--line-strong)", textAlign: "left", padding: 8 }}></th>
            <th style={{ borderBottom: "1px solid var(--line-strong)", textAlign: "left", padding: 8 }}>일</th>
            <th style={{ borderBottom: "1px solid var(--line-strong)", textAlign: "left", padding: 8 }}>상태</th>
            <th style={{ borderBottom: "1px solid var(--line-strong)", textAlign: "left", padding: 8 }}>질문</th>
          </tr>
        </thead>
        <tbody>
          {items.map((r) => (
            <tr key={r.id}>
              <td style={{ borderBottom: "1px solid var(--line)", padding: 8, verticalAlign: "top" }}>
                <input
                  type="checkbox"
              ...
              <td style={{ borderBottom: "1px solid var(--line)", padding: 8, verticalAlign: "top", whiteSpace: "nowrap" }}>
                {r.exhibition_day}
              </td>
              <td style={{ borderBottom: "1px solid var(--line)", padding: 8, verticalAlign: "top" }}>
